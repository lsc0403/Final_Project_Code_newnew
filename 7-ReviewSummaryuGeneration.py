...
def analyze_reviews(data):
    ...
    for movie, reviews in data.items():
        ...
        average_review_length = sum(
            len(review['Review'].split()) for review in reviews) / total_reviews if total_reviews else 0
...
if __name__ == "__main__":
    ...
    # 生成并保存HTML文件
    html_filename = generate_html_fixed(descriptions, "movie_reviews_summary.html")
