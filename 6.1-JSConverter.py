...
excel_file_path = 'B-Modified_IMDB_Reviews.xlsx'  # Update this to your Excel file path
output_json_file_path = 'B-JSONData.json'  # Update this to your desired JSON file path
